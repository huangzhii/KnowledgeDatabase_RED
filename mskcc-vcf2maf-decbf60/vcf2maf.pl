...
my ( $vep_path, $vep_data, $vep_forks, $buffer_size, $any_allele ) = ( "/gpfs/home/z/h/zhihuan/Carbonate/Desktop/KnowledgeDatabase/vep", "/gpfs/home/z/h/zhihuan/Carbonate/Desktop/KnowledgeDatabase/.vep", 4, 5000, 0 );
my ( $ref_fasta, $filter_vcf ) = ( "/gpfs/home/z/h/zhihuan/Carbonate/Desktop/KnowledgeDatabase/.vep/homo_sapiens/86_GRCh37/Homo_sapiens.GRCh37.75.dna.primary_assembly.fa.gz", "/gpfs/home/z/h/zhihuan/Carbonate/Desktop/KnowledgeDatabase/.vep/ExAC_nonTCGA.r0.3.1.sites.vep.vcf.gz" );
...
if(( $species eq "homo_sapiens" and $ncbi_build eq "GRCh37" and $filter_vcf ) or ( $filter_vcf and $filter_vcf ne "/gpfs/home/z/h/zhihuan/Carbonate/Desktop/KnowledgeDatabase/.vep/ExAC_nonTCGA.r0.3.1.sites.vep.vcf.gz" )) {
